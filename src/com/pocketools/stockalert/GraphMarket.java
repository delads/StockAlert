...
public class GraphMarket extends Activity {
   ...
   // Gallery mGallery;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(mGraphView == null){
        	mGraphView = LayoutInflater.from(this).inflate(R.layout.graph_market, null);
        }
 ...
 /*       
   ...
   */     
        ...
        StringBuffer urlBuffer = new StringBuffer(consts.get(mTimeframe).replace("TICKER", mSymbol));
    	...
    	switch (requestCode) {
	    	...
	    	case GraphDuration.CHOOSE_TIMEFRAME:
	    		...
	    		if(resultCode == GraphDuration.CHOOSE_TIMEFRAME_SUCCESS){
		    		...
		    		mUrl = consts.get(mTimeframe).replace("TICKER", mSymbol);
